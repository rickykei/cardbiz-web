...
/* CLiENT LIST APP */
export const CLIENT_LIST_GET_LIST = "CLIENT_LIST_GET_LIST";
export const CLIENT_LIST_GET_LIST_SUCCESS = "CLIENT_LIST_GET_LIST_SUCCESS";
export const CLIENT_LIST_GET_LIST_ERROR = "CLIENT_LIST_GET_LIST_ERROR";
export const CLIENT_LIST_GET_LIST_WITH_FILTER = "CLIENT_LIST_GET_LIST_WITH_FILTER";
export const CLIENT_LIST_GET_LIST_WITH_ORDER = "CLIENT_LIST_GET_LIST_WITH_ORDER";
export const CLIENT_LIST_GET_LIST_SEARCH = "CLIENT_LIST_GET_LIST_SEARCH";
export const CLIENT_LIST_ADD_ITEM = "CLIENT_LIST_ADD_ITEM";
export const CLIENT_LIST_ADD_ITEM_SUCCESS = "CLIENT_LIST_ADD_ITEM_SUCCESS";
export const CLIENT_LIST_ADD_ITEM_ERROR = "CLIENT_LIST_ADD_ITEM_ERROR";
export const CLIENT_LIST_SELECTED_ITEMS_CHANGE = "CLIENT_LIST_SELECTED_ITEMS_CHANGE";
...
export const USER_LIST_SELECTED_ITEMS_CHANGE = "USER_LIST_SELECTED_ITEMS_CHANGE";

/* STAFF LIST APP */
export const STAFF_LIST_ADD_ITEM = "STAFF_LIST_ADD_ITEM";
export const STAFF_LIST_ADD_ITEM_SUCCESS = "STAFF_LIST_ADD_ITEM_SUCCESS";
export const STAFF_LIST_ADD_ITEM_ERROR = "STAFF_LIST_ADD_ITEM_ERROR";
export const STAFF_LIST_SELECTED_ITEMS_CHANGE = "STAFF_LIST_SELECTED_ITEMS_CHANGE";