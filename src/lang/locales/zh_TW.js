...
'form-company-profile-theme': 'E-Profile背景圖 (圖像必須是垂直的，文件名中不能包含空格和符號)',
   'forms.staff-note-timestamp': '備注記錄見面時間',
    ...
    'forms.download_staff_link_excel':'下載',
     'menu.hr.wallet':'電子錢包',
    'menu.wallets':'錢包選項',
    'menu.wallet-edit':'定制化',
    'input-groups.admin-wallet-setting':'客製化設計',
    'form-company-wallet-banner':'電子錢包橫幅',
    'forms.staff-wallet_logo_option':'圖像',
    'forms.staff-wallet_field1_option':'標題區域 1',
    'forms.staff-wallet_field2_option':'文字區域 2',
    'forms.staff-wallet_field3_option':'文字區域 3',
