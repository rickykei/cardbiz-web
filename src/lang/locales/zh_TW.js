...
'form-company-profile-theme': 'E-Profile背景圖 (建議尺寸: 526px x 1000px. 圖像必須是垂直的，文件名中不能包含空格和符號)',
   'forms.staff-note-timestamp': '備注記錄見面時間',
    ...
    'forms.download_staff_mobilesite_excel':'下載',
        'forms.staff-work_email_label-muted':'預設: Work',
    'forms.staff-work_email2_label-muted':'預設: Work',
    'forms.staff-work_email3_label-muted':'預設: Work',
    'forms.staff-home_email_label-muted':'預設: Work',
    'forms.staff-other_email_label-muted':'預設: Work',
    'forms.staff-work_tel_label-muted':'預設: Work',
    'forms.staff-work_tel2_label-muted':'預設: Work',
    'forms.staff-work_tel3_label-muted':'預設: Work',
    'forms.staff-work_tel4_label-muted':'預設: Work',
    'forms.staff-mobile_label-muted':'預設: Cell',
    'forms.staff-mobile2_label-muted':'預設: Cell',
    'forms.staff-mobile3_label-muted':'預設: Cell',
    'forms.staff-mobile4_label-muted':'預設: Cell',
    'forms.staff-home_tel_label-muted':'預設: Home',
    'forms.staff-fax_label-muted':'預設: Fax',
    'forms.staff-address_label-muted':'預設: Work',
    'forms.staff-address2_label-muted':'預設: Work',
    'forms.staff-address3_label-muted':'預設: Work',
    'forms.staff-address4_label-muted':'預設: Work',
