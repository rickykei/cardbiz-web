...
'pages.staff_no': 'Staff no.',
    ...
    'form-company-wallet-banner':'Wallet Banner - (Recommended Size: 80px x 300px. Must be horizontal and do not include space and symbol in the filename)',
  ...
  'forms.minisite-fontsize': 'Font size',
