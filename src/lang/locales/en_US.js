...
module.exports = {
  ...
  'form-staff-wechat-qrCode': 'Upload Wechat QR Code image here',
  ...
  'forms.staff-department-muted': 'e.g. Admin Department ',
  'forms.staff-country-muted': 'e.g. Country',
  ...
  'form-company-banner': 'Company Banner (Recommended Size: 2000 px x 1052px. Must be horizontal and do not include space and symbol in the filename)',
  ...
  'menu.staffs-list-header': 'Staff List',
    ...
    'forms.staff-fname': 'First Name',
    'forms.staff-firstname-muted': 'E.g. John',
    'forms.staff-lastname': 'Last Name',
    'forms.staff-lastname-muted': 'E.g. Smith/ Chan',   
    'forms.staff-company_name_eng': 'Company Name',
    'forms.staff-company_name_eng-muted': 'E.g. ABC Limited',
    'forms.staff-company_name_chi': 'Company Name in other language',
    'forms.staff-company_name_chi-muted': 'E.g. 一二三有限公司', 
    'forms.staff-staff_no': 'Staff No.',
  'forms.staff-work_email2': 'Work E-mail 2',
    ...
    'forms.staff-work_tel3':'Work Tel-3',
        ...
        'forms.staff-web_link_label': 'Website-1 Title',
        'forms.staff-web_link_label-muted': 'E.g. Online Brochure',
            'forms.staff-web_link_label2': 'Website-2 Title',
...
'pages.staff_no': 'Staff no.',
    ...
    'forms.staff-mname':'Middle Name',
    'forms.staff-middlename-muted': 'E.g. Simpson/ Tai Man',
    'forms.staff-prefixname': 'Prefix',
    'forms.staff-prefixname-muted': 'E.g. Dr., Sir, Captain',
    'forms.staff-othername': 'Other Name',
    'forms.staff-othername-muted': 'E.g. 陳大文',
    'forms.staff-prodesname': 'Professional Designation',
    'forms.staff-prodesname-muted': 'E.g. CFA',
    'dropdowns.deactive': 'De-Active',
    'menu.staffsdactive.profile': 'De-Active Staff',
    'menu.staffsdeactive': 'De-Active Staff',
    'dropdowns.active': 'Activate',
    'menu.card-add':'Add Card',
    ...
    'menu.wallets':'Edit Wallet',
    'menu.wallet-edit':'Mobile Wallet',
    'input-groups.admin-wallet-setting':'Customized Your Mobile Wallet',
    'form-company-wallet-banner':'Wallet Banner - (Recommended Size: 1032px x 336px. Must be horizontal and do not include space and symbol in the filename)',
    'forms.staff-wallet_logo_option':'Image',
    'forms.staff-wallet_field1_option':'Title Area 1',
    'forms.staff-wallet_field2_option':'Text Area 2',
    'forms.staff-wallet_field3_option':'Text Area 3',
    'forms.staff-wallet_qrcode_option':'Select QR Code',
    'forms.staff-wallet_text_color':'Text Color',
    'forms.staff-wallet_text_color-muted':'e.g. #FFFFFF',
    'forms.staff-wallet_bg_color':'Background Color',
    'forms.staff-wallet_bg_color-muted':'e.g. #000000',
    'cards.tab-admin-qr5':'Google Pass',
    'cards.tab-admin-qr6':'Apple Pass',
    'cards.tab-admin-qr7':'Web Pass',
    'cards.tab-admin-qr8':'Mobile Wallet Pass',
    'cards.tab-admin-log5':'Apple Pass',
    'cards.tab-admin-log6':'Web Pass',
    'cards.tab-admin-log4':'Google Pass',
    'forms.download_staff_gw_excel':'Download',
    'forms.download_staff_aw_excel':'Download',
    'forms.download_staff_mobilesite_excel':'Download',
    'forms.staff-work_email_label-muted':'Default Setting: Email',
    'forms.staff-work_email2_label-muted':'Default Setting: Email',
    'forms.staff-work_email3_label-muted':'Default Setting: Email',
    'forms.staff-home_email_label-muted':'Default Setting: Home Email',
    'forms.staff-other_email_label-muted':'Default Setting: Other Email',
    'forms.staff-work_tel_label-muted':'Default Setting: Tel',
    'forms.staff-work_tel2_label-muted':'Default Setting: Tel',
    'forms.staff-work_tel3_label-muted':'Default Setting: Tel',
    'forms.staff-work_tel4_label-muted':'Default Setting: Tel',
    'forms.staff-mobile_label-muted':'Default Setting: Mobile',
    'forms.staff-mobile2_label-muted':'Default Setting: Mobile',
    'forms.staff-mobile3_label-muted':'Default Setting: Mobile',
    'forms.staff-mobile4_label-muted':'Default Setting: Mobile',
    'forms.staff-home_tel_label-muted':'Default Setting: Home Tel',
    'forms.staff-fax_label-muted':'Default Setting: Fax no.',
    'forms.staff-address_label-muted':'Default Setting: Address',
  ...
  /* 2024/12/26 Minisite */
  'menu.style.minisite': 'E-Profile',
  'menu.style.minisite.admin': 'E-Profile',
  'menu.minisite-list': 'E-Profile',
  'menu.minisite': 'E-Profile Design',
  'menu.minisite-edit': 'Customisation',
  'forms.minisite-fontcolor': 'Font Color',
  'forms.minisite-fontcolor-muted': 'E.g #FFFFFF',
  'forms.minisite-fontsize': 'Text Size',
  'forms.minisite-fontsize-muted': '10',
  'forms.minisite-fontfamily': 'Font Style',
  'forms.minisite-fontfamily-muted': 'Arial Black',
  'forms.minisite-text-color': 'Other Text Color',
  'forms.minisite-title-text-color': 'Secondary Theme Color',
  'forms.minisite-social-icon-bg-color': 'Social Icons Color',
  'forms.minisite-button-color': 'Button Color',
  'forms.minisite-links-hover-color': 'Sidebar - Hovered Button Color',
  'forms.minisite-links-not-hover-color': 'Sidebar - Inactive Page Color',
  'forms.minisite-key-wording-color': 'Primary Theme Color',
  'forms.minisite-site-bg-color': 'Page Color',
  'forms.minisite-left-nav-bar-color': 'Sidebar Color',
  'forms.minisite-bio-wording-color': 'Bio Text Color',
