...
module.exports = {
  ...
  'forms.basic': 'Basic',
  'forms.email': 'E-mail',
  'forms.email-muted': 'Enter Company Name Here',
  ...
  'menu.users-list': 'Employee List',
  'menu.users': 'Company', 
  'menu.clients-edit': 'Staff Info',
  'menu.staff-profile': 'Profile',
  'menu.staff-edit': 'Edit', 
  ...
  'forms.staff-country-muted': 'e.g. Hong Kong',
  'forms.staff-bio-muted': 'e.g. biography or license',
  ...
  'menu.card-edit': 'Edit',   
  'menu.staffs-profile': 'Edit Staff Info', 
  ...
  'pages.additionalInfo': 'Additional Info Link',
  'menu.webprofilepage': 'Digital Profile',
  'menu.downloadVCFContent': 'Contact Info',
